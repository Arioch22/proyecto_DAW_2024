...
return new class extends Migration
{
    ...
    {
        Schema::create('delivery_note_rows', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('customer_delivery_note_id');
            ...
            $table->foreign('customer_delivery_note_id')->references('id')->on('customer_delivery_notes')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('delivery_note_rows');
    }
};
