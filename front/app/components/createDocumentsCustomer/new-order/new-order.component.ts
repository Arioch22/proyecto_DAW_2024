...
export class NewOrderComponent implements OnInit {
  ...
  comprobarDocument() {
    ...
    if (this.formGroup.valid && this.validateIva(productLine) && this.productLines.length > 0 && this.validateQuantity(productLine) ) {
        ...
        this.ordersService.createOrderRows(orderLinesData).subscribe(
          ...
          (error) => {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Error',
              text: 'Hubo un error al crear las líneas del pedido',
            });
          }
        );
        ...
        this.invoiceService.createInvoiceRows(orderLinesData).subscribe(
          ...
          (error) => {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Error',
              text: 'Hubo un error al crear las líneas de la factura',
            });
          }
        );
        ...
        this.deliveryService.createDeliveryRows(orderLinesData).subscribe(
          ...
          (error) => {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Error',
              text: 'Hubo un error al crear las líneas del albarán',
            });
          }
        );
      }
